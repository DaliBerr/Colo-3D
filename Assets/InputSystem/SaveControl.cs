...
//     version 1.14.2
//     from Assets/InputSystem/SaveControl.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputSystem/SaveControl.inputactions".
    /// </summary>
    /// <remarks>
    ...
    /// </code>
    /// </example>
    public partial class @SaveControls: IInputActionCollection2, IDisposable
    {
        /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""SaveLoad"",
            ""id"": ""7cac35ea-9758-487e-8708-a84e6f8ae10c"",
            ""actions"": [
                {
                    ""name"": ""Save"",
                    ""type"": ""Button"",
                    ""id"": ""b4f1ece2-144c-4eaa-8ed5-26e03c16b607"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""Load"",
                    ""type"": ""Button"",
                    ""id"": ""5e275908-085f-4429-bf4d-133e96460f91"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""9e93faa5-16d1-45d9-ae8d-5f5ab52edcfc"",
                    ""path"": ""<Keyboard>/f5"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""a2575a4d-88f7-47f9-a02c-4e59ff8fc80a"",
                    ""path"": ""<Keyboard>/f6"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        ~@SaveControls()
        {
            UnityEngine.Debug.Assert(!m_SaveLoad.enabled, "This will cause a leak and performance issues, SaveControls.SaveLoad.Disable() has not been called.");
        }
        ...
        /// <summary>
        /// Provides access to input actions defined in input action map "SaveLoad".
        /// </summary>
        public struct SaveLoadActions
        {
            ...
            /// </summary>
            public SaveLoadActions(@SaveControls wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            /// Provides access to the underlying input action "SaveLoad/Save".
            /// </summary>
            public InputAction @Save => m_Wrapper.m_SaveLoad_Save;
            /// <summary>
            /// Provides access to the underlying input action "SaveLoad/Load".
            /// </summary>
            ...
            /// <summary>
            /// Implicitly converts an <see ref="SaveLoadActions" /> to an <see ref="InputActionMap" /> instance.
            /// </summary>
            ...
            /// <summary>
            /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="SaveLoadActions.UnregisterCallbacks(ISaveLoadActions)" />.
            /// </summary>
            /// <seealso cref="SaveLoadActions.UnregisterCallbacks(ISaveLoadActions)" />
            ...
            /// </remarks>
            /// <seealso cref="SaveLoadActions.AddCallbacks(ISaveLoadActions)" />
            /// <seealso cref="SaveLoadActions.RemoveCallbacks(ISaveLoadActions)" />
            /// <seealso cref="SaveLoadActions.UnregisterCallbacks(ISaveLoadActions)" />
        ...
        /// <summary>
        /// Provides a new <see cref="SaveLoadActions" /> instance referencing this action map.
        /// </summary>
        public SaveLoadActions @SaveLoad => new SaveLoadActions(this);
        /// <summary>
        /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "SaveLoad" which allows adding and removing callbacks.
        /// </summary>
        /// <seealso cref="SaveLoadActions.AddCallbacks(ISaveLoadActions)" />
        /// <seealso cref="SaveLoadActions.RemoveCallbacks(ISaveLoadActions)" />
